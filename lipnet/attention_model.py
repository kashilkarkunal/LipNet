...
class LipNet(object):
    ...
    def build(self):
        ...
        self.attn = SeqSelfAttention(attention_type=SeqSelfAttention.ATTENTION_TYPE_MUL,
        ...
        self.dense1 = Dense(self.output_size, kernel_initializer='he_normal', name='dense1')(self.attn)
